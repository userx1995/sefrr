    ...
    registerHandlers(): void {
        ...
        this._fuseMockApiService
            ...
            .reply(({ request }) => {
                ...
                const sort = request.params.get('sort') || 'nameEn';
                ...
                // Sort the products
                if (sort === 'sku' || sort === 'nameEn' || sort === 'active') {
                    products.sort((a, b) => {
                ...
                if (search) {
                    // Filter the products
                    products = products.filter(contact => contact.nameEn && contact.nameEn.toLowerCase().includes(search.toLowerCase()));
                }
